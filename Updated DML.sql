...
INSERT INTO trips VALUES ('T4', TO_TIMESTAMP('2024-11-04 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-04 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Scheduled', 'S4');
INSERT INTO trips VALUES ('T5', TO_TIMESTAMP('2024-11-05 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2024-11-05 17:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Completed', 'S5');

-- Rides
//INSERT INTO rides VALUES ('R1', 'L1', 'L2', 'T1', 'U1', 'Completed');
//INSERT INTO rides VALUES ('R2', 'L2', 'L3', 'T2', 'U2', 'Completed');
//INSERT INTO rides VALUES ('R3', 'L3', 'L4', 'T3', 'U3', 'Scheduled');
//INSERT INTO rides VALUES ('R4', 'L4', 'L5', 'T4', 'U4', 'Scheduled');
//INSERT INTO rides VALUES ('R5', 'L5', 'L1', 'T5', 'Completed');

-- Sample data for rides table with 5 entries
...
INSERT INTO maintenance_schedules VALUES ('M4', 'S4', TO_DATE('2024-11-08', 'YYYY-MM-DD'), 'Brake check');
INSERT INTO maintenance_schedules VALUES ('M5', 'S5', TO_DATE('2024-11-09', 'YYYY-MM-DD'), 'Engine inspection');
